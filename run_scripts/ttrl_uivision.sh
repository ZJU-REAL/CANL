...
export EXP_NAME="${model_size}${learning_method}-${positive_reward}_${negative_reward}-${n1}_${n2}-bs${gradient_accumulation_steps}-${threshold}${adv_method}${adaptive_batch_method}" # TODO: change this to your own experiment name
export LOG_PATH="${REPO_HOME}/runs/${EXP_NAME}/log/debug_log.$(date +%Y-%m-%d-%H-%M-%S).txt"
export NCCL_P2P_DISABLE=1
export DEBUG_MODE="true" # Enable Debug if you want to see the rollout of model during RL

echo "REPO_HOME: $REPO_HOME"
data_paths="/home/liuyizhou/GUI_Agent/VLM-R1/dataset/ui-vision/rl/element_grounding_basic_rl.jsonl\
:/home/liuyizhou/GUI_Agent/VLM-R1/dataset/ui-vision/rl/element_grounding_functional_rl.jsonl\
:/home/liuyizhou/GUI_Agent/VLM-R1/dataset/ui-vision/rl/element_grounding_spatial_rl.jsonl"
image_folders="/home/liuyizhou/benchmark/UI-Vision/images\
:/home/liuyizhou/benchmark/UI-Vision/images\
:/home/liuyizhou/benchmark/UI-Vision/images"
model_path="/home/shenyl/hf/model/Qwen/Qwen2.5-VL-${model_size}-Instruct"
