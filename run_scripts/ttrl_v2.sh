...
export EXP_NAME="test1-${model_size}${learning_method}-${positive_reward}_${negative_reward}-${n1}_${n2}-bs${gradient_accumulation_steps}-${threshold}-${temperature}${adv_method}${adaptive_batch_method}" # TODO: change this to your own experiment name
