...
export EXP_NAME="InternVL3-3conf-${model_size}${learning_method}-${positive_reward}_${negative_reward}-${n1}_${n2}-bs${gradient_accumulation_steps}-${threshold}-${temperature}${adv_method}${adaptive_batch_method}" # TODO: change this to your own experiment name
...
model_path="/home/real/GUI_Agent_Infra/models/InternVL3-8B"
